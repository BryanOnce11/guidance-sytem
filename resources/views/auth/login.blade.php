            ...
            <div class="w-full max-w-md">
                ...
                <form action="#" class="space-y-6">
                    ...
                    <div class="flex justify-center space-x-4 mt-8">
                        <button class="bg-orange-500 text-white py-3 px-6 rounded-lg hover:bg-orange-600 transition duration-200">LOGIN</button>
                        <button class="bg-white border border-gray-300 text-gray-700 py-3 px-6 rounded-lg hover:bg-gray-100 transition duration-200">REGISTER</button>
                    </div>
                </form>
            </div>
        </div>
