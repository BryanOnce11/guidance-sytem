    ...
    <div class="flex flex-col w-full min-h-screen md:flex-row">
        ...
        <div class="w-full md:w-[60%] px-4 md:px-12 py-8 md:py-0 flex items-center justify-center bg-center bg-no-repeat bg-cover"
            ...
            <div class="w-full max-w-md p-8 rounded-lg bg-white/90">
                <h2 class="mb-8 text-3xl font-bold text-center text-gray-800 md:text-4xl">Login</h2>
                ...
                <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-center mt-8 space-x-4">
                        <button type="submit"
                            class="px-6 py-3 text-white transition duration-200 bg-orange-500 rounded-lg hover:bg-orange-600">
                            LOGIN
                        </button>
                        <a href="{{ route('register') }}"
                            class="px-6 py-3 text-gray-700 transition duration-200 bg-white border border-gray-300 rounded-lg hover:bg-gray-100">
                            REGISTER
                        </a>
                    </div>
                </form>
