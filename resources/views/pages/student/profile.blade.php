@extends('layouts.app')
@section('content')
    <form action="{{ route('student.profile.update', $user->student) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="p-5">
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <label for="status" class="inline-block mb-2">Student Status</label>
                            <select name="status" id="status"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                                <option value="Old"
                                    {{ old('status', $user->student->status) == 'Old' ? 'selected' : '' }}>Old</option>
                                <option value="New"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <label for="student_id" class="inline-block mb-2">Student ID</label>
                            <input value="{{ old('student_id', $user->student->student_id) }}" name="student_id"
                                type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('student_id')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                        ...
                        <div class="w-full">
                            <label for="course" class="inline-block mb-2">Course</label>
                            <select name="course"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                        ...
                        <div class="w-full">
                            <label for="year_lvl" class="inline-block mb-2">Year Level</label>
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <label for="lname" class="inline-block mb-2">Last Name</label>
                            <input value="{{ old('lname', ucwords($user->student->lname)) }}" name="lname" type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('lname')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="w-full">
                            <label for="fname" class="inline-block mb-2">First Name</label>
                            <input value="{{ old('lname', ucwords($user->student->fname)) }}" name="fname" type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('fname')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="w-full">
                            <label for="m_i" class="inline-block mb-2">Middle Name</label>
                            <input value="{{ old('lname', ucwords($user->student->m_i)) }}" name="m_i" type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('m_i')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <label for="gender" class="inline-block mb-2">Gender</label>
                            <select name="gender"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                        ...
                        <div class="w-full">
                            <label for="civil_status" class="inline-block mb-2">Civil Status</label>
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            ...
                            <input value="{{ old('age', $user->student->age) }}" name="age" type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('age')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="w-full">
                            <label for="birth_date" class="inline-block mb-2">Date Of Birth</label>
                            <input value="{{ old('age', $user->student->birth_date) }}" name="birth_date" type="date"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('birth_date')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="w-full">
                            <label for="birth_place" class="inline-block mb-2">Place Of Birth</label>
                            <input value="{{ old('age', ucwords($user->student->birth_place)) }}" name="birth_place"
                                type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('birth_place')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                        ...
                        <div class="w-full">
                            <label for="citizenship" class="inline-block mb-2">Citizenship</label>
                            <input value="{{ old('age', $user->student->citizenship) }}" name="citizenship"
                                type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('age')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            ...
                            <input value="{{ old('age', ucwords($user->student->email)) }}" name="email"
                                type="email"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('email')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                        ...
                        <div class="w-full">
                            <label for="contact_num" class="inline-block mb-2">Contact Number</label>
                            <input value="{{ old('age', $user->student->contact_num) }}" name="contact_num"
                                type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('contact_num')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <label for="height" class="inline-block mb-2">Height</label>
                            <input value="{{ old('age', $user->student->height) }}" name="height" type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('height')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="w-full">
                            <label for="weight" class="inline-block mb-2">Weight</label>
                            <input value="{{ old('age', $user->student->weight) }}" name="weight" type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('weight')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="w-full">
                            <label for="blood_type" class="inline-block mb-2">Blood Type</label>
                            <input value="{{ old('age', $user->student->blood_type) }}" name="blood_type" type="text"
                                class="w-full px-3 py-2 text-sm transition duration-200 ease-in-out rounded-md shadow-sm border-slate-200">
                            @error('blood_type')
                                <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <h2 class="mb-2 text-base font-medium">While Studying At Palawan State University, You Are
                                Staying?</h2>
        ...
        <div class="mt-8 intro-y box">
            ...
            <div class="p-5">
                <div class="flex flex-wrap gap-x-5">
                    ...
                    <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                    ...
                    <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                        <div class="w-full sm:flex-1">
                            ...
                            <input name="f_birth_date" id="f_birth_date" type="date" required
                        ...
                        <div class="w-full sm:flex-1">
                            ...
                            <input name="f_contact_num" id="f_contact_num" type="text" required
                    ...
                    <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                        ...
                        <div class="w-full sm:flex-1">
                            ...
                            <input name="f_avg_monthly_income" id="f_avg_monthly_income" type="text" required
                    ...
                    <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                        ...
                        <div class="w-full sm:flex-1">
                            ...
                            <select name="parent_status" id="update-profile-form-8" required
                    ...
                    <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                        <div class="w-full sm:flex-1">
                            ...
                            <input name="birth_rank" id="birth_rank" type="text"
                                value="{{ old('birth_rank', ucwords($user->student->family_back->birth_rank ?? '')) }}"
                                placeholder="Input text" required
                                class="w-full text-sm transition duration-200 ease-in-out rounded-md shadow-sm disabled:bg-slate-100 disabled:cursor-not-allowed border-slate-200 placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50">
                            @error('birth_rank')
                                <div class="mt-1 text-sm text-danger">{{ $message }}</div>
                        ...
                        <div class="w-full sm:flex-1">
                            ...
                            <input name="number_of_siblings" id="number_of_siblings" type="text"
                                value="{{ old('number_of_siblings', ucwords($user->student->family_back->number_of_siblings ?? '')) }}"
                                placeholder="Input text" required
                                class="w-full text-sm transition duration-200 ease-in-out rounded-md shadow-sm disabled:bg-slate-100 disabled:cursor-not-allowed border-slate-200 placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50">
                        ...
                        <div class="w-full sm:flex-1">
                            ...
                            <input name="number_of_children" id="number_of_children" type="text"
                                value="{{ old('number_of_children', ucwords($user->student->family_back->number_of_children ?? '')) }}"
                                placeholder="Input text" required
                                class="w-full text-sm transition duration-200 ease-in-out rounded-md shadow-sm disabled:bg-slate-100 disabled:cursor-not-allowed border-slate-200 placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50">
                    ...
                    <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                        ...
                        <div class="w-full sm:flex-1">
                            ...
                            <input name="s_avg_monthly_income" id="s_avg_monthly_income" type="text"
                                value="{{ old('s_avg_monthly_income', ucwords($user->student->family_back->spouse->avg_monthly_income ?? '')) }}"
                                placeholder="Input text" required
                                class="w-full text-sm transition duration-200 ease-in-out rounded-md shadow-sm disabled:bg-slate-100 disabled:cursor-not-allowed border-slate-200 placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50">
                ...
                <div class="flex flex-wrap gap-x-5">
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            ...
                            <input required name="elementary[school_attended]" id="elementary[school_attended]"
                                type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="elementary[school_year]" id="elementary[school_year]" type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="elementary[school_address]" id="elementary[school_address]"
                                type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="elementary[honors_received]" id="elementary[honors_received]"
                                type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            ...
                            <input required name="high_school[school_attended]" id="high_school[school_attended]"
                                type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="high_school[school_year]" id="high_school[school_year]" type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="high_school[school_address]" id="high_school[school_address]"
                                type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="high_school[honors_received]" id="high_school[honors_received]"
                                type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            ...
                            <input required name="vocational[school_attended]" id="vocational[school_attended]"
                                type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="vocational[school_year]" id="vocational[school_year]" type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="vocational[school_address]" id="vocational[school_address]"
                                type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="vocational[honors_received]" id="vocational[honors_received]"
                                type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            ...
                            <input required name="college[school_attended]" id="college[school_attended]" type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="college[school_year]" id="college[school_year]" type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="college[school_address]" id="college[school_address]" type="text"
                        ...
                        <div class="w-full">
                            ...
                            <input required name="college[honors_received]" id="college[honors_received]" type="text"
                    ...
                    <div class="w-full mt-2">
                        ...
                        <input required name="scholarship" id="scholarship" type="text"
                ...
                <div class="flex flex-wrap gap-x-5">
                    ...
                    <div class="flex flex-row flex-wrap w-full gap-4 mt-5 mb-4">
                        ...
                        <div class="flex items-center w-full sm:w-auto">
                            ...
                            <label data-tw-merge for="checkbox-switch-9" class="ml-2 cursor-pointer">Dance
                                Group</label>
                        </div>
                    </div>
                    ...
                    <input required name="special_skills" id="update-profile-form-6" type="text"
                    ...
                    <label>Hobbies</label>
                    <input required name="hobbies" id="update-profile-form-6" type="text"
                    ...
                    <div class="flex flex-row flex-wrap w-full gap-4 mt-5 mb-4">
                        ...
                        <div class="flex items-center w-full mr-4 sm:w-auto">
                            ...
                            <label data-tw-merge for="checkbox-switch-politics"
                                class="ml-2 cursor-pointer">Politics</label>
                        </div>
                    </div>
                    ...
                    <input required name="subject_best_like" id="update-profile-form-6" type="text"
                    ...
                    <input required name="subject_least_like" id="update-profile-form-6" type="text"
        ...
        <div class="mt-8 intro-y box">
            ...
            <div class="p-5">
                <div class="flex flex-wrap gap-x-5">
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <label for="update-profile-form-8" class="inline-block mb-2">Do You Smoke
                                Cigarette?</label>
                        ...
                        <div class="w-full">
                            <label for="update-profile-form-8" class="inline-block mb-2">Do You Drink
                                Liquior?</label>
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="w-full">
                            <label for="update-profile-form-8" class="inline-block mb-2">Have You Ever Disciplined
                                In
                                School?</label>
            ...
            <div class="p-5">
                <div class="flex flex-wrap gap-x-5">
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            <div class="w-full">
                                ...
                                <input name="counselling_record_1[date]" id="counselling_record_1[date]"
                                    type="date"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            <div class="w-full">
                                <input name="counselling_record_2[date]" id="counselling_record_2[date]"
                                    type="date"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            <div class="w-full">
                                <input name="counselling_record_3[date]" id="counselling_record_3[date]"
                                    type="date"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_1[remarks]" id="scholastic_record_1_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_2[remarks]" id="scholastic_record_2_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_3[remarks]" id="scholastic_record_3_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_4[remarks]" id="scholastic_record_4_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_5[remarks]" id="scholastic_record_5_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_6[remarks]" id="scholastic_record_6_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_7[remarks]" id="scholastic_record_7_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_8[remarks]" id="scholastic_record_8_remarks"
                                    type="text"
                    ...
                    <div class="flex flex-col w-full gap-3 sm:flex-row">
                        <div class="flex flex-col w-full gap-3 mt-5 sm:flex-row">
                            ...
                            <div class="w-full">
                                ...
                                <input name="scholastic_record_9[remarks]" id="scholastic_record_9_remarks"
                                    type="text"
        ...
        <div class="mt-8 intro-y box">
            ...
            <div class="p-5">
                <div class="flex flex-wrap gap-x-5">
                    <h2 class="mr-auto text-base font-medium">
                        Given below is a list of problems which are often troubling the students of your age. Please
                        read
                        through the list slowly, and when you came to a problem which suggests something that is
                        troubling
                ...
                <div class="problem-checklist">
                    <div class="flex flex-col mt-2 sm:flex-row">
                        ...
                        <div class="flex items-center w-full mb-4 mr-4">
                            ...
                            <label for="checkbox1" class="ml-2 cursor-pointer">Feeling tired most of the
                                time</label>
                        </div>
                        ...
                        <div class="flex items-center w-full mb-4 mr-4">
                            <input name="check_list[]" type="checkbox" id="checkbox3" class="cursor-pointer"
                                value="Frequent colds/cough/sore throat"
                                @if (in_array(
                                        'Frequent colds/cough/sore throat',
                                        old('check_list', $user->student->problem_checklist->check_list ?? []))) checked @endif />
                            <label for="checkbox3" class="ml-2 cursor-pointer">Frequent colds/cough/sore
                                throat</label>
                        </div>
                        ...
                        <div class="flex items-center w-full mb-4 mr-4">
                            <input name="check_list[]" type="checkbox" id="checkbox6" class="cursor-pointer"
                                ...
                                @if (in_array(
                                        ...
                                        old('check_list', $user->student->problem_checklist->check_list ?? []))) checked @endif />
                            <label for="checkbox6" class="ml-2 cursor-pointer">Financial help from home/benefactor
                                not
                                enough</label>
                        </div>
                    ...
                    <div class="flex flex-col mt-2 sm:flex-row">
                        ...
                        <div class="flex items-center w-full mb-4 mr-4">
                            <input name="check_list[]" type="checkbox" id="checkbox43" class="cursor-pointer"
                                value="Disappointed in a love affair"
                                @if (in_array('Disappointed in a love affair', old('check_list', $user->student->problem_checklist->check_list ?? []))) checked @endif />
                            <label for="checkbox43" class="ml-2 cursor-pointer">Disappointed in a love
                                affair</label>
                        </div>

                        <div class="flex items-center w-full mb-4 mr-4">
                            <input name="check_list[]" type="checkbox" id="checkbox44" class="cursor-pointer"
                                value="Deciding whether to go steady"
                                @if (in_array('Deciding whether to go steady', old('check_list', $user->student->problem_checklist->check_list ?? []))) checked @endif />
                            <label for="checkbox44" class="ml-2 cursor-pointer">Deciding whether to go
                                steady</label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col mt-2 sm:flex-row">
                        ...
                        <div class="flex items-center w-full mb-4 mr-4">
                            <input name="check_list[]" type="checkbox" id="checkbox45" class="cursor-pointer"
                                value="Being criticized by my parents"
                                @if (in_array('Being criticized by my parents', old('check_list', $user->student->problem_checklist->check_list ?? []))) checked @endif />
                            <label for="checkbox45" class="ml-2 cursor-pointer">Being criticized by my
                                parents</label>
                        </div>
                        ...
                        <div class="flex items-center w-full mb-4 mr-4">
                            <input name="check_list[]" type="checkbox" id="checkbox48" class="cursor-pointer"
                                value="Parents are unreasonable strict"
                                @if (in_array('Parents are unreasonable strict', old('check_list', $user->student->problem_checklist->check_list ?? []))) checked @endif />
                            <label for="checkbox48" class="ml-2 cursor-pointer">Parents are unreasonable
                                strict</label>
                        </div>
                        ...
                        <div class="flex items-center w-full mb-4 mr-4">
                            <input name="check_list[]" type="checkbox" id="checkbox27" class="cursor-pointer"
                                ...
                                @if (in_array(
                                        ...
                                        old('check_list', $user->student->problem_checklist->check_list ?? []))) checked @endif />
                            <label for="checkbox27" class="ml-2 cursor-pointer">Doubting I can get a job in my
                                chosen
                                course</label>
                        </div>
